...
- [x] 一般的な翻訳シーンをカバー
  ...
  - [x] 選択テキスト翻訳
    - [x] 任意のページで翻訳ボックスを開き、複数サービスで翻訳を比較
    - [x] 英語辞書
    - [x] 単語の收藏
  - [x] マウスホバー翻訳
- [x] 多様な翻訳表示
...
- 一部のAIモデルが統合翻訳をサポートしていない：
  ...
  - または、カスタムAPIを使用して対応します。詳細は[カスタムAPIサンプルドキュメント](custom-api_v2.md)を参照してください
...
- [x] **英語辞書のバックアップ機構**：翻訳サービス障害時に他辞書へ切替、またはローカル辞書へフォールバック。
